    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <Input
            v-model="localResume.basics!.label"
        ...
        <div>
          ...
          <Input
            v-model="localResume.basics!.email"
            type="email"
        ...
        <div>
          ...
          <Input
            v-model="localResume.basics!.phone"
        ...
        <div>
          ...
          <Input
            v-model="localResume.basics!.url"
            type="url"
        ...
        <div>
          ...
          <Input
            v-model="localResume.basics!.location!.address"
        ...
        <div>
          ...
          <Input
            v-model="localResume.basics!.location!.city"
        ...
        <div>
          ...
          <Input
            v-model="localResume.basics!.location!.region"
        ...
        <div>
          ...
          <Input
            v-model="localResume.basics!.location!.postalCode"
            placeholder="94115"
          />
        </div>
        <div>
          ...
          <Input
            v-model="localResume.basics!.location!.countryCode"
            placeholder="US"
          />
        </div>
        <div>
          ...
          >
          <Input
            v-model="localResume.basics!.image"
            type="url"
            ...
            <div class="mb-4 p-4 border rounded-lg">
              <div class="flex justify-between items-center">
                <div class="flex items-center gap-3">
                  <button
                    type="button"
                    class="item-drag-handle cursor-grab active:cursor-grabbing text-gray-500 hover:text-gray-800"
                    :aria-label="`Drag profile ${index + 1}`"
                  >
                    ::
                  </button>
                ...
                <div class="flex gap-2">
                  <Button
                    variant="outline"
                    size="sm"
                    @click="toggleItemCollapse(profile)"
                  >
                    {{ isItemCollapsed(profile) ? "Expand" : "Collapse" }}
                  </Button>
                  <Button
                    variant="destructive"
                    size="sm"
              ...
              <div
                v-show="!isItemCollapsed(profile)"
          ...
          <div class="mb-4 p-4 border rounded-lg">
            <div class="flex justify-between items-center">
              ...
              <div class="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  @click="toggleItemCollapse(work)"
                >
                  {{ isItemCollapsed(work) ? "Expand" : "Collapse" }}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
            ...
            >
              ...
              <div class="md:col-span-2">
                ...
                >
                <Textarea
                  v-model="workHighlights[index]"
                  :rows="4"
                  placeholder="Enter each highlight on a new line"
                  @input="updateHighlights(index, $event)"
                />
              </div>
            </div>
          </div>
        ...
        <template #item="{ element: edu, index }">
          <div class="mb-4 p-4 border rounded-lg">
            <div class="flex justify-between items-center">
              <div class="flex items-center gap-3">
                <button
                  type="button"
                  class="item-drag-handle cursor-grab active:cursor-grabbing text-gray-500 hover:text-gray-800"
                  :aria-label="`Drag education ${index + 1}`"
                >
                  ::
                </button>
              ...
              <div class="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  @click="toggleItemCollapse(edu)"
                >
                  {{ isItemCollapsed(edu) ? "Expand" : "Collapse" }}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
            ...
            >
              ...
              <div class="md:col-span-2">
                <label class="block text-sm font-medium mb-2"
                  >Courses (one per line)</label
                >
                <Textarea
                  v-model="educationCourses[index]"
                  :rows="3"
          ...
          <div class="mb-4 p-4 border rounded-lg">
            <div class="flex justify-between items-center">
              <div class="flex items-center gap-3">
                <button
                  type="button"
                  class="item-drag-handle cursor-grab active:cursor-grabbing text-gray-500 hover:text-gray-800"
                  :aria-label="`Drag volunteer ${index + 1}`"
                >
                  ::
                </button>
              ...
              <div class="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  @click="toggleItemCollapse(vol)"
                >
                  {{ isItemCollapsed(vol) ? "Expand" : "Collapse" }}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
            ...
            >
              ...
              <div class="md:col-span-2">
                ...
                >
                <Textarea
                  v-model="volunteerHighlights[index]"
                  :rows="3"
                  placeholder="Enter each highlight on a new line"
      ...
      >
        <template #item="{ element: project, index }">
          <div class="mb-4 p-4 border rounded-lg">
            <div class="flex justify-between items-center">
              <div class="flex items-center gap-3">
                <button
                  type="button"
                  class="item-drag-handle cursor-grab active:cursor-grabbing text-gray-500 hover:text-gray-800"
                  :aria-label="`Drag project ${index + 1}`"
                >
                  ::
                </button>
              ...
              <div class="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  @click="toggleItemCollapse(project)"
                >
                  {{ isItemCollapsed(project) ? "Expand" : "Collapse" }}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
            ...
            <div
              v-show="!isItemCollapsed(project)"
              class="grid grid-cols-1 md:grid-cols-2 gap-4"
            >
              <div>
                <label class="block text-sm font-medium mb-2"
              ...
              <div class="md:col-span-2">
                ...
                >
                <Textarea
                  v-model="projectHighlights[index]"
                  :rows="3"
                  placeholder="Enter each highlight on a new line"
            ...
            <div class="flex justify-between items-center">
              ...
              <div class="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  @click="toggleItemCollapse(award)"
                >
                  {{ isItemCollapsed(award) ? "Expand" : "Collapse" }}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
            ...
            <div class="flex justify-between items-center">
              <div class="flex items-center gap-3">
                <button
                  type="button"
                  class="item-drag-handle cursor-grab active:cursor-grabbing text-gray-500 hover:text-gray-800"
                  :aria-label="`Drag publication ${index + 1}`"
                >
                  ::
                </button>
              ...
              <div class="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  @click="toggleItemCollapse(pub)"
                >
                  {{ isItemCollapsed(pub) ? "Expand" : "Collapse" }}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
            ...
            <div class="flex justify-between items-center">
              <div class="flex items-center gap-3">
                <button
                  type="button"
                  class="item-drag-handle cursor-grab active:cursor-grabbing text-gray-500 hover:text-gray-800"
                  :aria-label="`Drag certificate ${index + 1}`"
                >
                  ::
                </button>
              ...
              <div class="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  @click="toggleItemCollapse(cert)"
                >
                  {{ isItemCollapsed(cert) ? "Expand" : "Collapse" }}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
            ...
            <div class="flex justify-between items-center">
              <div class="flex items-center gap-3">
                <button
                  type="button"
                  class="item-drag-handle cursor-grab active:cursor-grabbing text-gray-500 hover:text-gray-800"
                  :aria-label="`Drag language ${index + 1}`"
                >
                  ::
                </button>
              ...
              <div class="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  @click="toggleItemCollapse(lang)"
                >
                  {{ isItemCollapsed(lang) ? "Expand" : "Collapse" }}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
      ...
      >
        <template #item="{ element: interest, index }">
          <div class="mb-4 p-4 border rounded-lg">
            <div class="flex justify-between items-center">
              <div class="flex items-center gap-3">
                <button
                  type="button"
                  class="item-drag-handle cursor-grab active:cursor-grabbing text-gray-500 hover:text-gray-800"
                  :aria-label="`Drag interest ${index + 1}`"
                >
                  ::
                </button>
              ...
              <div class="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  @click="toggleItemCollapse(interest)"
                >
                  {{ isItemCollapsed(interest) ? "Expand" : "Collapse" }}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
            ...
            <div
              v-show="!isItemCollapsed(interest)"
              class="grid grid-cols-1 md:grid-cols-2 gap-4"
            >
              <div>
                <label class="block text-sm font-medium mb-2">Name</label>
              ...
              <div>
                ...
                >
                <Input
                  v-model="interestKeywords[index]"
                  placeholder="Ferrets, Unicorns"
                />
              </div>
            </div>
          </div>
            ...
            <div class="flex justify-between items-center">
              <div class="flex items-center gap-3">
                <button
                  type="button"
                  class="item-drag-handle cursor-grab active:cursor-grabbing text-gray-500 hover:text-gray-800"
                  :aria-label="`Drag reference ${index + 1}`"
                >
                  ::
                </button>
              ...
              <div class="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  @click="toggleItemCollapse(ref)"
                >
                  {{ isItemCollapsed(ref) ? "Expand" : "Collapse" }}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
            ...
            <div class="flex justify-between items-center">
              ...
              <div class="flex gap-2">
                <Button
                  variant="outline"
                  size="sm"
                  @click="toggleItemCollapse(skill)"
                >
                  {{ isItemCollapsed(skill) ? "Expand" : "Collapse" }}
                </Button>
                <Button
                  variant="destructive"
                  size="sm"
...
watch(
  ...
  (newData) => {
    if (newData) {
      ...
      if (!data.basics.profiles) data.basics.profiles = [];
      ensureResumeArrays(data);
...
const draggableItemKeys = new WeakMap<object, string>();
let draggableItemKeyCount = 0;

function getItemKey(item: object) {
  const existingKey = draggableItemKeys.get(item);
  if (existingKey) return existingKey;

  const newKey = `resume-item-${draggableItemKeyCount}`;
  draggableItemKeyCount += 1;
  draggableItemKeys.set(item, newKey);
  return newKey;
}

function isItemCollapsed(item: object) {
  return Boolean(collapsedItems.value[getItemKey(item)]);
}

function toggleItemCollapse(item: object) {
  const key = getItemKey(item);
  collapsedItems.value[key] = !collapsedItems.value[key];
}

function ensureResumeArrays(resume: Resume) {
  resume.work ||= [];
  resume.volunteer ||= [];
  resume.education ||= [];
  resume.awards ||= [];
...
function syncDerivedFields() {
  workHighlights.value = (localResume.work || []).map((w) =>
    (w.highlights || []).join("\n"),
  );
  workSkills.value = (localResume.work || []).map((w) =>
    (w.skills || []).join(", "),
  );
  skillKeywords.value = (localResume.skills || []).map((s) =>
    (s.keywords || []).join(", "),
  );
  educationCourses.value = (localResume.education || []).map((e) =>
    (e.courses || []).join("\n"),
  );
  volunteerHighlights.value = (localResume.volunteer || []).map((v) =>
    (v.highlights || []).join("\n"),
  );
  projectHighlights.value = (localResume.projects || []).map((p) =>
    (p.highlights || []).join("\n"),
  );
  interestKeywords.value = (localResume.interests || []).map((i) =>
    (i.keywords || []).join(", "),
  );
}
  ...
  (newKeywords) => {
    newKeywords.forEach((keywords, index) => {
      if (localResume.skills && localResume.skills[index]) {
        localResume.skills[index].keywords = keywords
          .split(",")
          .map((k) => k.trim())
          .filter(Boolean);
      }
...
watch(
  ...
  (newSkills) => {
    newSkills.forEach((skills, index) => {
      if (localResume.work && localResume.work[index]) {
        localResume.work[index].skills = skills
          .split(",")
          .map((s) => s.trim())
          .filter(Boolean);
      }
  ...
  (newKeywords) => {
    newKeywords.forEach((keywords, index) => {
      if (localResume.interests && localResume.interests[index]) {
        localResume.interests[index].keywords = keywords
          .split(",")
          .map((k) => k.trim())
          .filter(Boolean);
      }
